...
int main()
{
	...
	bool l=0;
	char S[20],r;//declaring the character string and the character pointer
	...
	l=contain(S,r);//calling the function and assinging the returned value to l
	if(l==1)
